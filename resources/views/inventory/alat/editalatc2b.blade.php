...
@section('container')
    ...
    <form action="/editc2b/{{ $c2b_alat->id_alat }}" method="POST" class="col-md-5 d-block text-center mx-auto">
        ...
        <div class=" form-floating mb-1">
            ...
            id="nama_alat" placeholder="Nama Alat"  value="{{ $c2b_alat->nama_alat }}" >
        ...
        <div class=" form-floating mb-1">
            ...
            id="merk" placeholder="Merk Alat"  value="{{ $c2b_alat->merkt }}" >
        ...
        <div class=" form-floating mb-1">
            ...
            id="ukuran" placeholder="Ukuran Alat"  value="{{ $c2b_alat->ukuran }}" >
        ...
        <div class=" form-floating mb-1">
            ...
            id="jumlah" placeholder="Jumlah Alat"  value="{{  $c2b_alat->jumlah  }}" >
        ...
        <div class=" form-floating mb-1">
            ...
            id="rusak" placeholder="Rusak Alat"  value="{{ $c2b_alat->rusak  }}" >
